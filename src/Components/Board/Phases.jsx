...
import PhaseCard from "../Helpers/PhaseCard";

const Phases = ({ setIsOpen }) => {
  return (
    <div className="flex flex-col sm:flex-row sm:flex-wrap sm:justify-center items-center md:content-start gap-4 mt-8 md:mt-4 lg:mt-0 relative">
      <button
        className="absolute lg:right-0 md:right-3 -top-8 right-0 py-1 px-2 bg-blue-500 text-white text-sm font-bold rounded-lg hover:bg-blue-600"
        onClick={() => {
          setIsOpen(true);
        }}
      >
